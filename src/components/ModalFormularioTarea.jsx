...
const ModalFormularioTarea = () => {
  ...
  useEffect(() => {
    ...
    // A cada que cambie tarea va verificar si hay algo en tarea, si hay, asigna los valores, si no, asigna string vacio 
    if (tarea?._id) {
      setId(tarea._id)
  ...
  const handleSubmit = async e => {
    ...
    await submitTarea({ id: tarea._id, nombre, descripcion, fechaEntrega, prioridad, proyecto: params.id })

    // Despues de listo, resetear el state
    setId('')
    setNombre('')
    setDescripcion('')
    setFechaEntrega('')
